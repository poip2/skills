...
> Top-level route for enhancing an existing PowerPoint deck without regenerating it. V1 implements the narration module: speaker notes and page transitions.
...
| `narration.transitions` | Enabled | Add page-level transitions for selected slides |
