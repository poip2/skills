...
|----------|------------|---------|------|-------------|--------|-----------|
| cover_bg.png | 1280x720 | Cover background | Background | user | Existing | - |
...
|--------|---------|-------------------|
| **Pending** | Acquisition needed (`Acquire Via: web`); not yet attempted | Image Acquisition Phase (Step 5) consumes this; must not remain after Step 5 |
...
3. Executor generates SVGs (svg_output/)
   ├── Existing / Sourced → <image href="../images/xxx.png" .../>
