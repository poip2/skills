...
- `scripts/`: internal provider implementations (e.g. `template_import/`, `svg_finalize/`, `source_to_md/`)
...
| Image tools | `latex_render.py`, `analyze_images.py`, `gemini_watermark_remover.py` | [docs/image.md](./docs/image.md) |
